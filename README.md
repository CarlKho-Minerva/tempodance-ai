...
- **Practice can be gated step-by-step or full-routine.** Step-by-step freezes the source video, audio, and coach overlay on every count until the learner holds at least 65% focused-pose accuracy, while upper body, lower body, and combined passes keep cognitive load bounded. Full routine enables continuous complete-movement playback.
